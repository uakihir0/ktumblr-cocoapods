...
@class KtumblrCoreAuthAuthorizeUrlRequest, KtumblrCoreAuthOAuth2TokenRefreshRequest, KtumblrCoreAuthOAuth2TokenRequest, KtumblrCoreAuthOAuth2TokenResponse, KtumblrCoreAuthOAuth2TokenResponseCompanion, KtumblrCoreBlog, KtumblrCoreBlogAvatar, KtumblrCoreBlogAvatarCompanion, KtumblrCoreBlogAvatarRequest, KtumblrCoreBlogBannerRequest, KtumblrCoreBlogBannerResponse, KtumblrCoreBlogBannerResponseCompanion, KtumblrCoreBlogCompanion, KtumblrCoreBlogDeleteRequest, KtumblrCoreBlogDraftsRequest, KtumblrCoreBlogFollowersRequest, KtumblrCoreBlogFollowersResponse, KtumblrCoreBlogFollowersResponseCompanion, KtumblrCoreBlogFollowingRequest, KtumblrCoreBlogFollowingResponse, KtumblrCoreBlogFollowingResponseCompanion, KtumblrCoreBlogInTrail, KtumblrCoreBlogInTrailCompanion, KtumblrCoreBlogInfoRequest, KtumblrCoreBlogInfoResponse, KtumblrCoreBlogInfoResponseCompanion, KtumblrCoreBlogLikesRequest, KtumblrCoreBlogLikesResponse, KtumblrCoreBlogLikesResponseCompanion, KtumblrCoreBlogPostEditTagsRequest, KtumblrCoreBlogPostRequest, KtumblrCoreBlogPostUpdateRequest, KtumblrCoreBlogPostsRequest, KtumblrCoreBlogPostsResponse, KtumblrCoreBlogPostsResponseCompanion, KtumblrCoreBlogQueueRequest, KtumblrCoreBlogReblogRequest, KtumblrCoreBlogSubmissionsRequest, KtumblrCoreBlogTheme, KtumblrCoreBlogThemeCompanion, KtumblrCoreBlogUpdateInfoRequest, KtumblrCoreBody<T>, KtumblrCoreBodyCompanion, KtumblrCoreDialogue, KtumblrCoreDialogueCompanion, KtumblrCoreFileRequest, KtumblrCoreFollowerUser, KtumblrCoreFollowerUserCompanion, KtumblrCoreIdInTrail, KtumblrCoreIdInTrailCompanion, KtumblrCoreLegacyAnswerPost, KtumblrCoreLegacyAnswerPostCompanion, KtumblrCoreLegacyAudioPost, KtumblrCoreLegacyAudioPostCompanion, KtumblrCoreLegacyChatPost, KtumblrCoreLegacyChatPostCompanion, KtumblrCoreLegacyLinkPost, KtumblrCoreLegacyLinkPostCompanion, KtumblrCoreLegacyPhotoPost, KtumblrCoreLegacyPhotoPostCompanion, KtumblrCoreLegacyPostcardPost, KtumblrCoreLegacyPostcardPostCompanion, KtumblrCoreLegacyQuotePost, KtumblrCoreLegacyQuotePostCompanion, KtumblrCoreLegacyTextPost, KtumblrCoreLegacyTextPostCompanion, KtumblrCoreLegacyVideoPost, KtumblrCoreLegacyVideoPostCompanion, KtumblrCoreMeta, KtumblrCoreMetaCompanion, KtumblrCoreNote, KtumblrCoreNoteCompanion, KtumblrCorePhoto, KtumblrCorePhotoCompanion, KtumblrCorePhotoSize, KtumblrCorePhotoSizeCompanion, KtumblrCorePost, KtumblrCorePostCompanion, KtumblrCoreReblog, KtumblrCoreReblogCompanion, KtumblrCoreResource, KtumblrCoreResponse<T>, KtumblrCoreResponseUnit, KtumblrCoreTaggedRequest, KtumblrCoreTrail, KtumblrCoreTrailCompanion, KtumblrCoreUser, KtumblrCoreUserCompanion, KtumblrCoreUserDashboardRequest, KtumblrCoreUserDashboardResponse, KtumblrCoreUserDashboardResponseCompanion, KtumblrCoreUserFollowRequest, KtumblrCoreUserFollowingRequest, KtumblrCoreUserFollowingResponse, KtumblrCoreUserFollowingResponseCompanion, KtumblrCoreUserLikeRequest, KtumblrCoreUserLikesRequest, KtumblrCoreUserLikesResponse, KtumblrCoreUserLikesResponseCompanion, KtumblrCoreUserResponse, KtumblrCoreUserResponseCompanion, KtumblrCoreUserUnfollowRequest, KtumblrCoreUserUnlikeRequest, KtumblrCoreVideo, KtumblrCoreVideoCompanion, KtumblrKotlinArray<T>, KtumblrKotlinByteArray, KtumblrKotlinByteIterator, KtumblrKotlinException, KtumblrKotlinIllegalStateException, KtumblrKotlinNothing, KtumblrKotlinPair<__covariant A, __covariant B>, KtumblrKotlinRuntimeException, KtumblrKotlinThrowable, KtumblrKotlinx_serialization_coreSerialKind, KtumblrKotlinx_serialization_coreSerializersModule, KtumblrKtumblrFactory;
...
*/
- (void)oAuth2TokenRequest:(KtumblrCoreAuthOAuth2TokenRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreAuthOAuth2TokenResponse *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("oAuth2Token(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreAuthOAuth2TokenResponse *> *)oAuth2TokenBlockingRequest:(KtumblrCoreAuthOAuth2TokenRequest *)request __attribute__((swift_name("oAuth2TokenBlocking(request:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)oAuth2TokenRefreshRequest:(KtumblrCoreAuthOAuth2TokenRefreshRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreAuthOAuth2TokenResponse *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("oAuth2TokenRefresh(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreAuthOAuth2TokenResponse *> *)oAuth2TokenRefreshBlockingRequest:(KtumblrCoreAuthOAuth2TokenRefreshRequest *)request __attribute__((swift_name("oAuth2TokenRefreshBlocking(request:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogAvatarRequest:(KtumblrCoreBlogAvatarRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<NSString *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogAvatar(request:completionHandler:)")));
- (KtumblrCoreResponse<NSString *> *)blogAvatarBlockingRequest:(KtumblrCoreBlogAvatarRequest *)request __attribute__((swift_name("blogAvatarBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogBannerRequest:(KtumblrCoreBlogBannerRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogBannerResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogBanner(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogBannerResponse *> *> *)blogBannerBlockingRequest:(KtumblrCoreBlogBannerRequest *)request __attribute__((swift_name("blogBannerBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogDraftPostsRequest:(KtumblrCoreBlogDraftsRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogDraftPosts(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> *)blogDraftPostsBlockingRequest:(KtumblrCoreBlogDraftsRequest *)request __attribute__((swift_name("blogDraftPostsBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogFollowersRequest:(KtumblrCoreBlogFollowersRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogFollowersResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogFollowers(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogFollowersResponse *> *> *)blogFollowersBlockingRequest:(KtumblrCoreBlogFollowersRequest *)request __attribute__((swift_name("blogFollowersBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogFollowingRequest:(KtumblrCoreBlogFollowingRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogFollowingResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogFollowing(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogFollowingResponse *> *> *)blogFollowingBlockingRequest:(KtumblrCoreBlogFollowingRequest *)request __attribute__((swift_name("blogFollowingBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogInfoRequest:(KtumblrCoreBlogInfoRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogInfoResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogInfo(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogInfoResponse *> *> *)blogInfoBlockingRequest:(KtumblrCoreBlogInfoRequest *)request __attribute__((swift_name("blogInfoBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogLikesRequest:(KtumblrCoreBlogLikesRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogLikesResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogLikes(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogLikesResponse *> *> *)blogLikesBlockingRequest:(KtumblrCoreBlogLikesRequest *)request __attribute__((swift_name("blogLikesBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogPostsRequest:(KtumblrCoreBlogPostsRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogPosts(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> *)blogPostsBlockingRequest:(KtumblrCoreBlogPostsRequest *)request __attribute__((swift_name("blogPostsBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogQueuedPostsRequest:(KtumblrCoreBlogQueueRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogQueuedPosts(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> *)blogQueuedPostsBlockingRequest:(KtumblrCoreBlogQueueRequest *)request __attribute__((swift_name("blogQueuedPostsBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogSubmissionsRequest:(KtumblrCoreBlogSubmissionsRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogSubmissions(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreBlogPostsResponse *> *> *)blogSubmissionsBlockingRequest:(KtumblrCoreBlogSubmissionsRequest *)request __attribute__((swift_name("blogSubmissionsBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)blogUpdateInfoRequest:(KtumblrCoreBlogUpdateInfoRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("blogUpdateInfo(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)blogUpdateInfoBlockingRequest:(KtumblrCoreBlogUpdateInfoRequest *)request __attribute__((swift_name("blogUpdateInfoBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)postCreateRequest:(KtumblrCoreBlogPostRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postCreate(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)postCreateBlockingRequest:(KtumblrCoreBlogPostRequest *)request __attribute__((swift_name("postCreateBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)postDeleteRequest:(KtumblrCoreBlogDeleteRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postDelete(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)postDeleteBlockingRequest:(KtumblrCoreBlogDeleteRequest *)request __attribute__((swift_name("postDeleteBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)postEditRequest:(KtumblrCoreBlogPostRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postEdit(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)postEditBlockingRequest:(KtumblrCoreBlogPostRequest *)request __attribute__((swift_name("postEditBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)postEditTagsRequest:(KtumblrCoreBlogPostEditTagsRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postEditTags(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)postEditTagsBlockingRequest:(KtumblrCoreBlogPostEditTagsRequest *)request __attribute__((swift_name("postEditTagsBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)postReblogRequest:(KtumblrCoreBlogReblogRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postReblog(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)postReblogBlockingRequest:(KtumblrCoreBlogReblogRequest *)request __attribute__((swift_name("postReblogBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)postUpdateRequest:(KtumblrCoreBlogPostUpdateRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postUpdate(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)postUpdateBlockingRequest:(KtumblrCoreBlogPostUpdateRequest *)request __attribute__((swift_name("postUpdateBlocking(request:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)taggedRequest:(KtumblrCoreTaggedRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrKotlinArray<KtumblrCorePost *> *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("tagged(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrKotlinArray<KtumblrCorePost *> *> *> *)taggedBlockingRequest:(KtumblrCoreTaggedRequest *)request __attribute__((swift_name("taggedBlocking(request:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)followRequest:(KtumblrCoreUserFollowRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("follow(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)followBlockingRequest:(KtumblrCoreUserFollowRequest *)request __attribute__((swift_name("followBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)likeRequest:(KtumblrCoreUserLikeRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("like(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)likeBlockingRequest:(KtumblrCoreUserLikeRequest *)request __attribute__((swift_name("likeBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)unfollowRequest:(KtumblrCoreUserUnfollowRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("unfollow(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)unfollowBlockingRequest:(KtumblrCoreUserUnfollowRequest *)request __attribute__((swift_name("unfollowBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)unlikeRequest:(KtumblrCoreUserUnlikeRequest *)request completionHandler:(void (^)(KtumblrCoreResponseUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("unlike(request:completionHandler:)")));
- (KtumblrCoreResponseUnit *)unlikeBlockingRequest:(KtumblrCoreUserUnlikeRequest *)request __attribute__((swift_name("unlikeBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)userWithCompletionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("user(completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserResponse *> *> *)userBlocking __attribute__((swift_name("userBlocking()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)userDashboardRequest:(KtumblrCoreUserDashboardRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserDashboardResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("userDashboard(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserDashboardResponse *> *> *)userDashboardBlockingRequest:(KtumblrCoreUserDashboardRequest *)request __attribute__((swift_name("userDashboardBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)userFollowingRequest:(KtumblrCoreUserFollowingRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserFollowingResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("userFollowing(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserFollowingResponse *> *> *)userFollowingBlockingRequest:(KtumblrCoreUserFollowingRequest *)request __attribute__((swift_name("userFollowingBlocking(request:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)userLikesRequest:(KtumblrCoreUserLikesRequest *)request completionHandler:(void (^)(KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserLikesResponse *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("userLikes(request:completionHandler:)")));
- (KtumblrCoreResponse<KtumblrCoreBody<KtumblrCoreUserLikesResponse *> *> *)userLikesBlockingRequest:(KtumblrCoreUserLikesRequest *)request __attribute__((swift_name("userLikesBlocking(request:)")));
@end

__attribute__((swift_name("KotlinThrowable")))
@interface KtumblrKotlinThrowable : KtumblrBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCause:(KtumblrKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(KtumblrKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));

/**
 * @note annotations
 *   kotlin.experimental.ExperimentalNativeApi
*/
- (KtumblrKotlinArray<NSString *> *)getStackTrace __attribute__((swift_name("getStackTrace()")));
- (void)printStackTrace __attribute__((swift_name("printStackTrace()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) KtumblrKotlinThrowable * _Nullable cause __attribute__((swift_name("cause")));
@property (readonly) NSString * _Nullable message __attribute__((swift_name("message")));
- (NSError *)asError __attribute__((swift_name("asError()")));
@end

__attribute__((swift_name("KotlinException")))
@interface KtumblrKotlinException : KtumblrKotlinThrowable
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCause:(KtumblrKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer));
...
@interface KtumblrKotlinRuntimeException : KtumblrKotlinException
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCause:(KtumblrKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer));
...
@interface KtumblrKotlinIllegalStateException : KtumblrKotlinRuntimeException
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCause:(KtumblrKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer));
...
@interface KtumblrKotlinCancellationException : KtumblrKotlinIllegalStateException
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCause:(KtumblrKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreBlogBannerRequest")))
@interface KtumblrCoreBlogBannerRequest : KtumblrBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property NSString * _Nullable blogName __attribute__((swift_name("blogName")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreBlogBannerResponse")))
@interface KtumblrCoreBlogBannerResponse : KtumblrBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) KtumblrCoreBlogBannerResponseCompanion *companion __attribute__((swift_name("companion")));
...
@property NSString * _Nullable beforeId __attribute__((swift_name("beforeId")));
@property NSString * _Nullable blogName __attribute__((swift_name("blogName")));
...
@property KtumblrKotlinArray<NSString *> * _Nullable types __attribute__((swift_name("types")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreBlogUpdateInfoRequest")))
@interface KtumblrCoreBlogUpdateInfoRequest : KtumblrBase <KtumblrCoreMapRequest>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
@property NSString * _Nullable ask __attribute__((swift_name("ask")));
@property NSString * _Nullable blogName __attribute__((swift_name("blogName")));
@property (setter=setDescription:) NSString * _Nullable description_ __attribute__((swift_name("description_")));
@property KtumblrBoolean * _Nullable isDescriptionIndexable __attribute__((swift_name("isDescriptionIndexable")));
@property KtumblrBoolean * _Nullable isIndexFollowed __attribute__((swift_name("isIndexFollowed")));
@property NSString * _Nullable name __attribute__((swift_name("name")));
@property NSString * _Nullable submit __attribute__((swift_name("submit")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreBlogPostEditTagsRequest")))
@interface KtumblrCoreBlogPostEditTagsRequest : KtumblrBase <KtumblrCoreMapRequest>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
@property NSString * _Nullable blogName __attribute__((swift_name("blogName")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreBlogPostUpdateRequest")))
@interface KtumblrCoreBlogPostUpdateRequest : KtumblrBase <KtumblrCoreMapRequest>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSDictionary<NSString *, KtumblrKotlinPair<NSString *, KtumblrKotlinByteArray *> *> *)toFileMap __attribute__((swift_name("toFileMap()")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
...
@property NSString * _Nullable chatDialogue __attribute__((swift_name("chatDialogue")));
@property NSString * _Nullable chatLabel __attribute__((swift_name("chatLabel")));
@property NSString * _Nullable chatTitle __attribute__((swift_name("chatTitle")));
@property KtumblrKotlinArray<KtumblrCoreFileRequest *> * _Nullable data __attribute__((swift_name("data")));
@property NSString * _Nullable embed __attribute__((swift_name("embed")));
...
@property NSString * _Nullable linkDescription __attribute__((swift_name("linkDescription")));
@property NSString * _Nullable linkTitle __attribute__((swift_name("linkTitle")));
@property NSString * _Nullable linkUrl __attribute__((swift_name("linkUrl")));
@property NSString * _Nullable quoteSource __attribute__((swift_name("quoteSource")));
@property NSString * _Nullable quoteText __attribute__((swift_name("quoteText")));
@property NSString * _Nullable replyKey __attribute__((swift_name("replyKey")));
@property NSString * _Nullable slug __attribute__((swift_name("slug")));
@property NSString * _Nullable startDate __attribute__((swift_name("startDate")));
@property KtumblrKotlinArray<NSString *> * _Nullable tags __attribute__((swift_name("tags")));
@property NSString * _Nullable title __attribute__((swift_name("title")));
@property NSString * _Nullable type __attribute__((swift_name("type")));
@property NSString * _Nullable tzAddress __attribute__((swift_name("tzAddress")));
@end
...
@property (readonly) KtumblrCoreLegacyAudioPost * _Nullable asLegacyAudioPost __attribute__((swift_name("asLegacyAudioPost")));
@property (readonly) KtumblrCoreLegacyChatPost * _Nullable asLegacyChatPost __attribute__((swift_name("asLegacyChatPost")));
...
@property (readonly) KtumblrCoreLegacyPostcardPost * _Nullable asLegacyPostcardPost __attribute__((swift_name("asLegacyPostcardPost")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreBlogBannerResponse.Companion")))
@interface KtumblrCoreBlogBannerResponseCompanion : KtumblrBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KtumblrCoreBlogBannerResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<KtumblrKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
 ...
 *   kotlinx.serialization.Serializable(with=NormalClass(value=work/socialhub/ktumblr/util/json/BlogThemeSerializer))
*/
...
@interface KtumblrKotlinByteArray : KtumblrBase
+ (instancetype)arrayWithSize:(int32_t)size __attribute__((swift_name("init(size:)")));
+ (instancetype)arrayWithSize:(int32_t)size init:(KtumblrByte *(^)(KtumblrInt *))init __attribute__((swift_name("init(size:init:)")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (int8_t)getIndex:(int32_t)index __attribute__((swift_name("get(index:)")));
- (KtumblrKotlinByteIterator *)iterator __attribute__((swift_name("iterator()")));
...
@interface KtumblrKotlinPair<__covariant A, __covariant B> : KtumblrBase
- (instancetype)initWithFirst:(A _Nullable)first second:(B _Nullable)second __attribute__((swift_name("init(first:second:)"))) __attribute__((objc_designated_initializer));
- (KtumblrKotlinPair<A, B> *)doCopyFirst:(A _Nullable)first second:(B _Nullable)second __attribute__((swift_name("doCopy(first:second:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreFileRequest")))
@interface KtumblrCoreFileRequest : KtumblrBase
- (instancetype)initWithName:(NSString *)name data:(KtumblrKotlinByteArray *)data __attribute__((swift_name("init(name:data:)"))) __attribute__((objc_designated_initializer));
@property (readonly) KtumblrKotlinByteArray *data __attribute__((swift_name("data")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLegacyAudioPost")))
@interface KtumblrCoreLegacyAudioPost : KtumblrCorePost
- (instancetype)initWithBlogName:(NSString * _Nullable)blogName idString:(NSString * _Nullable)idString genesisPostId:(NSString * _Nullable)genesisPostId postUrl:(NSString * _Nullable)postUrl parentPostUrl:(NSString * _Nullable)parentPostUrl type:(NSString * _Nullable)type timestamp:(KtumblrInt * _Nullable)timestamp date:(NSString * _Nullable)date format:(NSString * _Nullable)format reblogKey:(NSString * _Nullable)reblogKey tags:(KtumblrKotlinArray<NSString *> * _Nullable)tags isBookmarklet:(KtumblrBoolean * _Nullable)isBookmarklet isMobile:(KtumblrBoolean * _Nullable)isMobile sourceUrl:(NSString * _Nullable)sourceUrl sourceTitle:(NSString * _Nullable)sourceTitle isLiked:(KtumblrBoolean * _Nullable)isLiked state:(NSString * _Nullable)state title:(NSString * _Nullable)title body:(NSString * _Nullable)body noteCount:(KtumblrInt * _Nullable)noteCount summary:(NSString * _Nullable)summary slug:(NSString * _Nullable)slug rebloggedFromId:(NSString * _Nullable)rebloggedFromId rebloggedFromUrl:(NSString * _Nullable)rebloggedFromUrl rebloggedFromName:(NSString * _Nullable)rebloggedFromName rebloggedFromTitle:(NSString * _Nullable)rebloggedFromTitle rebloggedFromUuid:(NSString * _Nullable)rebloggedFromUuid rebloggedFromCanMessage:(KtumblrBoolean * _Nullable)rebloggedFromCanMessage rebloggedFromFollowing:(KtumblrBoolean * _Nullable)rebloggedFromFollowing rebloggedRootId:(NSString * _Nullable)rebloggedRootId rebloggedRootUrl:(NSString * _Nullable)rebloggedRootUrl rebloggedRootName:(NSString * _Nullable)rebloggedRootName rebloggedRootTitle:(NSString * _Nullable)rebloggedRootTitle rebloggedRootUuid:(NSString * _Nullable)rebloggedRootUuid rebloggedRootCanMessage:(KtumblrBoolean * _Nullable)rebloggedRootCanMessage rebloggedRootFollowing:(KtumblrBoolean * _Nullable)rebloggedRootFollowing notes:(KtumblrKotlinArray<KtumblrCoreNote *> * _Nullable)notes blog:(KtumblrCoreBlog * _Nullable)blog reblog:(KtumblrCoreReblog * _Nullable)reblog trail:(KtumblrKotlinArray<KtumblrCoreTrail *> * _Nullable)trail __attribute__((swift_name("init(blogName:idString:genesisPostId:postUrl:parentPostUrl:type:timestamp:date:format:reblogKey:tags:isBookmarklet:isMobile:sourceUrl:sourceTitle:isLiked:state:title:body:noteCount:summary:slug:rebloggedFromId:rebloggedFromUrl:rebloggedFromName:rebloggedFromTitle:rebloggedFromUuid:rebloggedFromCanMessage:rebloggedFromFollowing:rebloggedRootId:rebloggedRootUrl:rebloggedRootName:rebloggedRootTitle:rebloggedRootUuid:rebloggedRootCanMessage:rebloggedRootFollowing:notes:blog:reblog:trail:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
@property (class, readonly, getter=companion) KtumblrCoreLegacyAudioPostCompanion *companion __attribute__((swift_name("companion")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLegacyChatPost")))
@interface KtumblrCoreLegacyChatPost : KtumblrCorePost
- (instancetype)initWithBlogName:(NSString * _Nullable)blogName idString:(NSString * _Nullable)idString genesisPostId:(NSString * _Nullable)genesisPostId postUrl:(NSString * _Nullable)postUrl parentPostUrl:(NSString * _Nullable)parentPostUrl type:(NSString * _Nullable)type timestamp:(KtumblrInt * _Nullable)timestamp date:(NSString * _Nullable)date format:(NSString * _Nullable)format reblogKey:(NSString * _Nullable)reblogKey tags:(KtumblrKotlinArray<NSString *> * _Nullable)tags isBookmarklet:(KtumblrBoolean * _Nullable)isBookmarklet isMobile:(KtumblrBoolean * _Nullable)isMobile sourceUrl:(NSString * _Nullable)sourceUrl sourceTitle:(NSString * _Nullable)sourceTitle isLiked:(KtumblrBoolean * _Nullable)isLiked state:(NSString * _Nullable)state title:(NSString * _Nullable)title body:(NSString * _Nullable)body noteCount:(KtumblrInt * _Nullable)noteCount summary:(NSString * _Nullable)summary slug:(NSString * _Nullable)slug rebloggedFromId:(NSString * _Nullable)rebloggedFromId rebloggedFromUrl:(NSString * _Nullable)rebloggedFromUrl rebloggedFromName:(NSString * _Nullable)rebloggedFromName rebloggedFromTitle:(NSString * _Nullable)rebloggedFromTitle rebloggedFromUuid:(NSString * _Nullable)rebloggedFromUuid rebloggedFromCanMessage:(KtumblrBoolean * _Nullable)rebloggedFromCanMessage rebloggedFromFollowing:(KtumblrBoolean * _Nullable)rebloggedFromFollowing rebloggedRootId:(NSString * _Nullable)rebloggedRootId rebloggedRootUrl:(NSString * _Nullable)rebloggedRootUrl rebloggedRootName:(NSString * _Nullable)rebloggedRootName rebloggedRootTitle:(NSString * _Nullable)rebloggedRootTitle rebloggedRootUuid:(NSString * _Nullable)rebloggedRootUuid rebloggedRootCanMessage:(KtumblrBoolean * _Nullable)rebloggedRootCanMessage rebloggedRootFollowing:(KtumblrBoolean * _Nullable)rebloggedRootFollowing notes:(KtumblrKotlinArray<KtumblrCoreNote *> * _Nullable)notes blog:(KtumblrCoreBlog * _Nullable)blog reblog:(KtumblrCoreReblog * _Nullable)reblog trail:(KtumblrKotlinArray<KtumblrCoreTrail *> * _Nullable)trail __attribute__((swift_name("init(blogName:idString:genesisPostId:postUrl:parentPostUrl:type:timestamp:date:format:reblogKey:tags:isBookmarklet:isMobile:sourceUrl:sourceTitle:isLiked:state:title:body:noteCount:summary:slug:rebloggedFromId:rebloggedFromUrl:rebloggedFromName:rebloggedFromTitle:rebloggedFromUuid:rebloggedFromCanMessage:rebloggedFromFollowing:rebloggedRootId:rebloggedRootUrl:rebloggedRootName:rebloggedRootTitle:rebloggedRootUuid:rebloggedRootCanMessage:rebloggedRootFollowing:notes:blog:reblog:trail:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
@property (class, readonly, getter=companion) KtumblrCoreLegacyChatPostCompanion *companion __attribute__((swift_name("companion")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="dialogue")
*/
@property (readonly) KtumblrKotlinArray<KtumblrCoreDialogue *> * _Nullable dialogue __attribute__((swift_name("dialogue")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLegacyPostcardPost")))
@interface KtumblrCoreLegacyPostcardPost : KtumblrCorePost
- (instancetype)initWithBlogName:(NSString * _Nullable)blogName idString:(NSString * _Nullable)idString genesisPostId:(NSString * _Nullable)genesisPostId postUrl:(NSString * _Nullable)postUrl parentPostUrl:(NSString * _Nullable)parentPostUrl type:(NSString * _Nullable)type timestamp:(KtumblrInt * _Nullable)timestamp date:(NSString * _Nullable)date format:(NSString * _Nullable)format reblogKey:(NSString * _Nullable)reblogKey tags:(KtumblrKotlinArray<NSString *> * _Nullable)tags isBookmarklet:(KtumblrBoolean * _Nullable)isBookmarklet isMobile:(KtumblrBoolean * _Nullable)isMobile sourceUrl:(NSString * _Nullable)sourceUrl sourceTitle:(NSString * _Nullable)sourceTitle isLiked:(KtumblrBoolean * _Nullable)isLiked state:(NSString * _Nullable)state title:(NSString * _Nullable)title body:(NSString * _Nullable)body noteCount:(KtumblrInt * _Nullable)noteCount summary:(NSString * _Nullable)summary slug:(NSString * _Nullable)slug rebloggedFromId:(NSString * _Nullable)rebloggedFromId rebloggedFromUrl:(NSString * _Nullable)rebloggedFromUrl rebloggedFromName:(NSString * _Nullable)rebloggedFromName rebloggedFromTitle:(NSString * _Nullable)rebloggedFromTitle rebloggedFromUuid:(NSString * _Nullable)rebloggedFromUuid rebloggedFromCanMessage:(KtumblrBoolean * _Nullable)rebloggedFromCanMessage rebloggedFromFollowing:(KtumblrBoolean * _Nullable)rebloggedFromFollowing rebloggedRootId:(NSString * _Nullable)rebloggedRootId rebloggedRootUrl:(NSString * _Nullable)rebloggedRootUrl rebloggedRootName:(NSString * _Nullable)rebloggedRootName rebloggedRootTitle:(NSString * _Nullable)rebloggedRootTitle rebloggedRootUuid:(NSString * _Nullable)rebloggedRootUuid rebloggedRootCanMessage:(KtumblrBoolean * _Nullable)rebloggedRootCanMessage rebloggedRootFollowing:(KtumblrBoolean * _Nullable)rebloggedRootFollowing notes:(KtumblrKotlinArray<KtumblrCoreNote *> * _Nullable)notes blog:(KtumblrCoreBlog * _Nullable)blog reblog:(KtumblrCoreReblog * _Nullable)reblog trail:(KtumblrKotlinArray<KtumblrCoreTrail *> * _Nullable)trail __attribute__((swift_name("init(blogName:idString:genesisPostId:postUrl:parentPostUrl:type:timestamp:date:format:reblogKey:tags:isBookmarklet:isMobile:sourceUrl:sourceTitle:isLiked:state:title:body:noteCount:summary:slug:rebloggedFromId:rebloggedFromUrl:rebloggedFromName:rebloggedFromTitle:rebloggedFromUuid:rebloggedFromCanMessage:rebloggedFromFollowing:rebloggedRootId:rebloggedRootUrl:rebloggedRootName:rebloggedRootTitle:rebloggedRootUuid:rebloggedRootCanMessage:rebloggedRootFollowing:notes:blog:reblog:trail:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
@property (class, readonly, getter=companion) KtumblrCoreLegacyPostcardPostCompanion *companion __attribute__((swift_name("companion")));
 ...
 *
 * @note annotations
 *   kotlinx.serialization.SerialName(value="broken_blog_name")
*/
@property (readonly) NSString * _Nullable brokenBlogName __attribute__((swift_name("brokenBlogName")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="is_current_item")
*/
@property (readonly) BOOL isCurrentItem __attribute__((swift_name("isCurrentItem")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="is_root_item")
*/
 ...
 *
 * @note annotations
 *   kotlinx.serialization.SerialName(value="header_bounds")
 *   kotlinx.serialization.Serializable(with=NormalClass(value=work/socialhub/ktumblr/util/json/HeaderBoundsSerializer))
*/
@property NSString * _Nullable headerBounds __attribute__((swift_name("headerBounds")));
...
@interface KtumblrKotlinByteIterator : KtumblrBase <KtumblrKotlinIterator>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (KtumblrByte *)next __attribute__((swift_name("next()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLegacyAudioPost.Companion")))
@interface KtumblrCoreLegacyAudioPostCompanion : KtumblrBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KtumblrCoreLegacyAudioPostCompanion *shared __attribute__((swift_name("shared")));
- (id<KtumblrKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
 ...
 */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLegacyChatPost.Companion")))
@interface KtumblrCoreLegacyChatPostCompanion : KtumblrBase
+ (instancetype)alloc __attribute__((unavailable));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KtumblrCoreLegacyChatPostCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreDialogue")))
@interface KtumblrCoreDialogue : KtumblrBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) KtumblrCoreDialogueCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString * _Nullable label __attribute__((swift_name("label")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
@property (readonly) NSString * _Nullable phrase __attribute__((swift_name("phrase")));
@end
 ...
 */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLegacyPostcardPost.Companion")))
@interface KtumblrCoreLegacyPostcardPostCompanion : KtumblrBase
+ (instancetype)alloc __attribute__((unavailable));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KtumblrCoreLegacyPostcardPostCompanion *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreDialogue.Companion")))
@interface KtumblrCoreDialogueCompanion : KtumblrBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KtumblrCoreDialogueCompanion *shared __attribute__((swift_name("shared")));
- (id<KtumblrKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
